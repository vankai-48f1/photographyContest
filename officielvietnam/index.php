...
<section class="countdown">
    ...
    <div class="countdown__content container">
        ...
        <div class="submission__main">
            <div class="submission__list">
                <div class="submission__item">
                    <div class="submission__item-thumb"></div>
                    <div class="submission__item-desc">
                        <div class="submission__item-name">"Tên bộ ảnh ở đây"</div>
                        <div class="submission__item-applicant">Tên thí sinh ở đây</div>
                        <div class="submission__item-vote-num">3000 Votes</div>
